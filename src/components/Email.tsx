    ...
    <Box w="100vw" h="100vh" display="flex" alignItems="center" justifyContent="center">
      <Box w="800px" h="500px" borderWidth="4px" borderColor="game.white" display="flex" flexDir="row" alignItems="start">
        <Grid w="100%" h="100%" templateRows="11% 14% 1fr 11%">
          ...
          <GridItem>
            <Box h="100%" borderWidth="0px" borderColor="game.white" display="flex" alignItems="center" justifyContent="flex-end">
              <Button
                marginRight="15px"
                marginBottom="15px"
                borderRadius="0px"
      ...
      <Modal isOpen={isReportModalOpen} onClose={handleReportModalClose} isCentered>
        ...
        <ModalContent borderRadius="0px"
          ...
          <ModalCloseButton borderWidth="1px" borderRadius="0" borderColor="game.white" _hover={{ color: "game.black", bg: "game.white" }}/>
          ...
          <ModalFooter bg="game.black" justifyContent="center">
            <Button w="60px"
                ...
                bg="game.black"
                color="game.white"
                _hover={{ color: "game.black", bg: "game.white" }} mr={3} onClick={handleReportModalClose}>
              Yes
            </Button>
            <Button w="60px"
                borderRadius="0px"
                ...
                bg="game.black"
                color="game.white"
                _hover={{ color: "game.black", bg: "game.white" }} onClick={handleReportModalClose}>
              No
            </Button>
          </ModalFooter>
        </ModalContent>
