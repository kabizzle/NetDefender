import { Box, Center, Flex, Button, FormLabel, Input, Textarea} from "@chakra-ui/react";
...
const Sandbox = () => {
  ...
  const testForm = () => {
    ...
    const handleEncrypt = () => {
      let toEncrypt = game_RSA.encrypt(userInput);
      if (toEncrypt != false) {
        console.log(toEncrypt);
        setDisplayText(toEncrypt);
      }
      else {
        console.log("unable to encrypt");
        setDisplayText("not encrypted");
      }
    }
