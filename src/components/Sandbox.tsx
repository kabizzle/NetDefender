...
const Sandbox = () => {
  ...
  const handleEncrypt = () => {
    ...
    if (givenPubKey){ // if user has inputted public key, use it to encrypt
  ...
  const handleDecrypt = () => {
    ...
    if (givenPrivKey){ // if user has inputted private key, use it to decrypt
    ...
    } else { // else, use game private key
