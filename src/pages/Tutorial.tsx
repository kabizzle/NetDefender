...
const Tutorial = ({ setShowTutorial }: { setShowTutorial: Dispatch<SetStateAction<boolean>> }) => {
  ...
  const handleClick = () => {
    ...
    if (count === 0) {
      ...
      setDisplayText('This is your progress section. Here, you can see points and special badges you have earned.');
      setArrowProps(['10em 0 0 20em', 'rotate(0.6turn)', '7.5em']);
    } else if (count === 2) {
      setDisplayText('Each week, new missions will be unlocked.');
      setArrowProps(['', '', '0']);
