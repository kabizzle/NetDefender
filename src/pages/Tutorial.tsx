...
const Tutorial = () => {
  ...
  const handleClick = () => {
    ...
    if (count === 1) { 
      setDisplayText("This is your progress section. Here, you can see your completion of the game, along with your current rating.");
      setArrowProps(["10em 0 0 20em", "rotate(0.6turn)", "7.5em"])
    }
    else if (count === 2) {
      setDisplayText("Here you can find your messages. Be sure to check new messages, as there may be hidden clues :)");
